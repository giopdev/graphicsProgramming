...
### GLFW
GLFW is a thin, multi-platform abstraction layer for creating and managing windows, handling input, and managing OpenGL and Vulkan contexts.

### tl;dr
GLFW let's us focus on OpenGL or Vulkan by providing platform-agnostic windows to render in.
...
_**ltrace only tracks dynamic links, slightly misleading..
since OpenGL entry points are statically linked here**_
